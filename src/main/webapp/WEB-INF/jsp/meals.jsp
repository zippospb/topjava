                    ...
                    <div class="row">
                        <div class="offset-2 col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control col-4" type="text" name="startDate" id="startDate">

                                <label class="col-form-label" for="endDate"><spring:message
                                        code="meal.endDate"/></label>
                                <input class="form-control col-4" type="text" name="endDate" id="endDate">
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control col-3" type="text" name="startTime" id="startTime">

                                <label class="col-form-label" for="endTime"><spring:message
                                        code="meal.endTime"/></label>
                                <input class="form-control col-3" type="text" name="endTime" id="endTime">
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <%--<input type="hidden" id="exceed" name="exceed" value="false">--%>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="convertAndSave()">
...
<script>
    i18n["addTitle"] = '<spring:message code="meal.title"/>';
